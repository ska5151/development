...
- [reference/api-reference.md](everything-claude-code_sample/skills/videodb/reference/api-reference.md) - Complete VideoDB Python SDK API reference
- [reference/search.md](everything-claude-code_sample/skills/videodb/reference/search.md) - In-depth guide to video search (spoken word and scene-based)
- [reference/editor.md](everything-claude-code_sample/skills/videodb/reference/editor.md) - Timeline editing, assets, and composition
- [reference/streaming.md](everything-claude-code_sample/skills/videodb/reference/streaming.md) - HLS streaming and instant playback
- [reference/generative.md](everything-claude-code_sample/skills/videodb/reference/generative.md) - AI-powered media generation (images, video, audio)
- [reference/rtstream.md](everything-claude-code_sample/skills/videodb/reference/rtstream.md) - Live stream ingestion workflow (RTSP/RTMP)
- [reference/rtstream-reference.md](everything-claude-code_sample/skills/videodb/reference/rtstream-reference.md) - RTStream SDK methods and AI pipelines
- [reference/capture.md](everything-claude-code_sample/skills/videodb/reference/capture.md) - Desktop capture workflow
- [reference/capture-reference.md](everything-claude-code_sample/skills/videodb/reference/capture-reference.md) - Capture SDK and WebSocket events
- [reference/use-cases.md](everything-claude-code_sample/skills/videodb/reference/use-cases.md) - Common video processing patterns and examples
