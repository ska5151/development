...
Common workflows and what VideoDB enables. For code details, see [api-reference.md](everything-claude-code_sample/skills/videodb/reference/api-reference.md), [capture.md](everything-claude-code_sample/skills/videodb/reference/capture.md), [editor.md](everything-claude-code_sample/skills/videodb/reference/editor.md), and [search.md](everything-claude-code_sample/skills/videodb/reference/search.md).
