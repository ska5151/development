...
Code-level details for VideoDB capture sessions. For workflow guide, see [capture.md](everything-claude-code_sample/skills/videodb/reference/capture.md).
...
Use [scripts/ws_listener.py](ws_listener.py) to connect and dump events to `${VIDEODB_EVENTS_DIR:-$HOME/.local/state/videodb}/videodb_events.jsonl`.
...
| RTStream methods | See [rtstream-reference.md](everything-claude-code_sample/skills/videodb/reference/rtstream-reference.md) |
...
For RTStream methods (indexing, transcription, alerts, batch config), see [rtstream-reference.md](everything-claude-code_sample/skills/videodb/reference/rtstream-reference.md).
