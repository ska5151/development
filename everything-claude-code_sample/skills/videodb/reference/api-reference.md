...
Reference material for the VideoDB skill. For usage guidance and workflow selection, start with [../SKILL.md](everything-claude-code_sample/skills/videodb/SKILL.md).
...
| `conn.create_capture_session(...)` | `CaptureSession` | Create a capture session (see [capture-reference.md](everything-claude-code_sample/skills/videodb/reference/capture-reference.md)) |
...
| `conn.connect_websocket(collection_id)` | `WebSocketConnection` | Connect to WebSocket (see [capture-reference.md](everything-claude-code_sample/skills/videodb/reference/capture-reference.md)) |
...
| `coll.create_capture_session(...)` | `CaptureSession` | Create a capture session (see [capture-reference.md](everything-claude-code_sample/skills/videodb/reference/capture-reference.md)) |
| `coll.get_capture_session(...)` | `CaptureSession` | Retrieve capture session (see [capture-reference.md](everything-claude-code_sample/skills/videodb/reference/capture-reference.md)) |
| `coll.connect_rtstream(url, name, ...)` | `RTStream` | Connect to a live stream (see [rtstream-reference.md](everything-claude-code_sample/skills/videodb/reference/rtstream-reference.md)) |
...
See [editor.md](everything-claude-code_sample/skills/videodb/reference/editor.md#caption-overlays) for full CaptionAsset usage with the Editor API.
...
For scene search, use `search_type=SearchType.semantic` with `index_type=IndexType.scene`. Pass `scene_index_id` when targeting a specific scene index. See [search.md](everything-claude-code_sample/skills/videodb/reference/search.md) for details.
...
For RTStream (live ingestion, indexing, transcription), see [rtstream-reference.md](everything-claude-code_sample/skills/videodb/reference/rtstream-reference.md).

For capture sessions (desktop recording, CaptureClient, channels), see [capture-reference.md](everything-claude-code_sample/skills/videodb/reference/capture-reference.md).
