...
For code-level details (SDK methods, parameters, examples), see [rtstream-reference.md](everything-claude-code_sample/skills/videodb/reference/rtstream-reference.md).
...
For capture session workflow, see [capture.md](everything-claude-code_sample/skills/videodb/reference/capture.md).
