...
For code-level details (SDK methods, event structures, AI pipelines), see [capture-reference.md](everything-claude-code_sample/skills/videodb/reference/capture-reference.md).
