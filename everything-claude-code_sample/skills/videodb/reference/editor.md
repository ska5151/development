...
For more streaming options (segment streams, search-to-stream, audio playback), see [streaming.md](everything-claude-code_sample/skills/videodb/reference/streaming.md).
