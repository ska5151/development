...
Videos **must be uploaded** to a collection before streams can be generated. For search-based streams, the video must also be **indexed** (spoken words and/or scenes). See [search.md](everything-claude-code_sample/skills/videodb/reference/search.md) for indexing details.
...
For detailed timeline editing, see [editor.md](everything-claude-code_sample/skills/videodb/reference/editor.md).
