...
- [Data Handling](data-handling.md) — Using the native `Builder` for JSON
- [System & Usage](system-usage.md) — Context, Sessions, Events, CLI usage
- [Testing Patterns](everything-claude-code_sample/skills/tinystruct-patterns/references/testing.md) — JUnit 5 integration and ActionRegistry testing
