> This file extends [common/testing.md](everything-claude-code_sample/rules/common/testing.md) with web-specific testing content.
...
- Keep CWV targets from [performance.md](everything-claude-code_sample/rules/web/performance.md)
