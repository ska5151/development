...
> 此文件扩展 [common/git-workflow.md](everything-claude-code_sample/rules/zh/git-workflow.md)，包含 git 操作之前的完整功能开发流程。
...
4. **提交与推送**
   - 详细的提交消息
   - 遵循约定式提交格式
   - 参见 [git-workflow.md](everything-claude-code_sample/rules/zh/git-workflow.md) 了解提交消息格式和 PR 流程
