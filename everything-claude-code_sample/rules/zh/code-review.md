...
- [testing.md](everything-claude-code_sample/rules/zh/testing.md) - 测试覆盖率要求
- [security.md](everything-claude-code_sample/rules/zh/security.md) - 安全检查清单
- [git-workflow.md](everything-claude-code_sample/rules/zh/git-workflow.md) - 提交标准
- [agents.md](everything-claude-code_sample/rules/zh/agents.md) - 代理委托
