...
- [CONTRIBUTING.md](everything-claude-code_sample/CONTRIBUTING.md) - General contribution guidelines
- [project-guidelines-template](project-guidelines-template.md) - Project-specific skill template
- [coding-standards](everything-claude-code_sample/skills/coding-standards/SKILL.md) - Example of standards skill
- [tdd-workflow](everything-claude-code_sample/skills/tdd-workflow/SKILL.md) - Example of workflow skill
- [security-review](everything-claude-code_sample/skills/security-review/SKILL.md) - Example of domain knowledge skill
