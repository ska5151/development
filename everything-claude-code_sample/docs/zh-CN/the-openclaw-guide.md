...
> **这是《Everything Claude Code 指南系列》的第 3 部分。** 第 1 部分是 [速成指南](everything-claude-code_sample/docs/zh-CN/the-shortform-guide.md)（设置和配置）。第 2 部分是 [长篇指南](everything-claude-code_sample/docs/zh-CN/the-longform-guide.md)（高级模式和工作流程）。本指南是关于安全性的——具体来说，当递归智能体基础设施将其视为次要问题时会发生什么。
...
OpenClaw 提供的所有功能都可以用技能和工具来复制——我在 [速成指南](everything-claude-code_sample/docs/zh-CN/the-shortform-guide.md) 和 [详细指南](everything-claude-code_sample/docs/zh-CN/the-longform-guide.md) 中介绍的那些。无需庞大的攻击面。无需未经审查的市场。无需为攻击者打开五扇额外的大门。
...
* [保护你的智能体简明指南](everything-claude-code_sample/docs/zh-CN/the-security-guide.md) — 实用防御指南
* [AgentShield on npm](https://www.npmjs.com/package/ecc-agentshield) — 零安装智能体安全扫描

> **系列导航：**
>
> * 第 1 部分：[关于 Claude Code 的一切简明指南](everything-claude-code_sample/docs/zh-CN/the-shortform-guide.md) — 设置与配置
> * 第 2 部分：[关于 Claude Code 的一切长篇指南](everything-claude-code_sample/docs/zh-CN/the-longform-guide.md) — 高级模式与工作流程
> * 第 3 部分：OpenClaw 的隐藏危险（本文） — 来自智能体前沿的安全教训
> * 第 4 部分：[保护你的智能体简明指南](everything-claude-code_sample/docs/zh-CN/the-security-guide.md) — 实用的智能体安全
