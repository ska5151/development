...
* [reference/api-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/api-reference.md) - 完整的 VideoDB Python SDK API 参考
* [reference/search.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/search.md) - 视频搜索深入指南（口语词和基于场景的）
* [reference/editor.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/editor.md) - 时间线编辑、资产和合成
* [reference/streaming.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/streaming.md) - HLS 流和即时播放
* [reference/generative.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/generative.md) - AI 驱动的媒体生成（图像、视频、音频）
* [reference/rtstream.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/rtstream.md) - 直播流摄取工作流程（RTSP/RTMP）
* [reference/rtstream-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/rtstream-reference.md) - RTStream SDK 方法和 AI 管道
* [reference/capture.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/capture.md) - 桌面捕获工作流程
* [reference/capture-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/capture-reference.md) - Capture SDK 和 WebSocket 事件
* [reference/use-cases.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/use-cases.md) - 常见的视频处理模式和示例
