...
常见工作流及 VideoDB 所实现的功能。代码详情请参阅 [api-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/api-reference.md)、[capture.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/capture.md)、[editor.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/editor.md) 和 [search.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/search.md)。
