...
有关代码级别的详细信息（SDK 方法、参数、示例），请参阅 [rtstream-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/rtstream-reference.md)。
...
有关捕获会话的工作流程，请参阅 [capture.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/capture.md)。
