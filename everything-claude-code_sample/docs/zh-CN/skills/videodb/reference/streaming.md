...
视频**必须上传**到某个集合后，才能生成流媒体。对于基于搜索的流媒体，视频还必须被**索引**（口语单词和/或场景）。有关索引的详细信息，请参阅 [search.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/search.md)。
...
有关详细的时间线编辑，请参阅 [editor.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/editor.md)。
