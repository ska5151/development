...
RTStream 操作的代码级详情。工作流程指南请参阅 [rtstream.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/rtstream.md)。
有关使用指导和流程选择，请从 [../SKILL.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/SKILL.md) 开始。
...
有关 WebSocket 事件结构和 ws\_listener 用法，请参阅 [capture-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/capture-reference.md)。
