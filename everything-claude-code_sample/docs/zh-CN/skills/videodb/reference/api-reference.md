...
VideoDB 技能参考材料。关于使用指南和工作流选择，请从 [../SKILL.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/SKILL.md) 开始。
...
| `conn.create_capture_session(...)` | `CaptureSession` | 创建捕获会话（见 [capture-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/capture-reference.md)） |
...
| `conn.connect_websocket(collection_id)` | `WebSocketConnection` | 连接到 WebSocket（见 [capture-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/capture-reference.md)） |
...
| `coll.create_capture_session(...)` | `CaptureSession` | 创建捕获会话（见 [capture-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/capture-reference.md)） |
| `coll.get_capture_session(...)` | `CaptureSession` | 检索捕获会话（见 [capture-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/capture-reference.md)） |
| `coll.connect_rtstream(url, name, ...)` | `RTStream` | 连接到实时流（见 [rtstream-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/rtstream-reference.md)） |
...
完整的 CaptionAsset 用法请见 [editor.md](everything-claude-code_sample/skills/videodb/reference/editor.md#caption-overlays) 中的编辑器 API。
...
对于场景搜索，请使用 `search_type=SearchType.semantic` 并设置 `index_type=IndexType.scene`。当针对特定场景索引时，传递 `scene_index_id`。详情请参阅 [search.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/search.md)。
...
关于 RTStream（实时摄取、索引、转录），请参阅 [rtstream-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/rtstream-reference.md)。

关于捕获会话（桌面录制、CaptureClient、频道），请参阅 [capture-reference.md](everything-claude-code_sample/docs/zh-CN/skills/videodb/reference/capture-reference.md)。
