...
![标题：Anthropic 黑客马拉松获胜者 - Claude Code 技巧与窍门](00-header.png)
...
![显示链式命令的终端](02-chaining-commands.jpeg)
*将命令链接在一起*
...
![PostToolUse 钩子反馈](03-posttooluse-hook.png)
...
![Supabase MCP 列出表](04-supabase-mcp.jpeg)
...
![/plugins 界面](05-plugins-interface.jpeg)
...
![显示 mgrep 的市场选项卡](06-marketplaces-mgrep.jpeg)
...
![Claude 机器人批准 PR](08-github-pr-review.jpeg)
*Claude 批准一个错误修复 PR*
...
![带有自定义命令的 Zed 编辑器](09-zed-editor.jpeg)
...
![VS Code Claude Code 扩展](10-vscode-extension.jpeg)
...
**注意：** 这是细节的一个子集。关于高级模式，请参阅 [长篇指南](everything-claude-code_sample/docs/zh-CN/the-longform-guide.md)。
