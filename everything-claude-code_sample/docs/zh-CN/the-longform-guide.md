...
![Header: The Longform Guide to Everything Claude Code](01-header.png)

***

> **前提**：本指南建立在 [关于 Claude Code 的简明指南](everything-claude-code_sample/docs/zh-CN/the-shortform-guide.md) 之上。如果你还没有设置技能、钩子、子代理、MCP 和插件，请先阅读该指南。

![Reference to Shorthand Guide](02-shortform-reference.png)
*速记指南 - 请先阅读此指南*
...
![Session Storage File Tree](03-session-storage.png)
...
![Model Selection Table](04-model-selection.png)
...
![Claude Model Pricing](05-pricing-table.png)
...
![mgrep 基准测试](06-mgrep-benchmark.png)
...
![Boris on Parallel Terminals](07-boris-parallel.png)
...
![Two Terminal Setup](08-two-terminals.png)
...
![25k+ GitHub Stars](09-25k-stars.png)
