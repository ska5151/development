**언어:** [English](everything-claude-code_sample/README.md) | [Português (Brasil)](everything-claude-code_sample/docs/pt-BR/README.md) | [简体中文](README.zh-CN.md) | [繁體中文](everything-claude-code_sample/docs/zh-TW/README.md) | [日本語](everything-claude-code_sample/docs/ja-JP/README.md) | 한국어 | [Türkçe](everything-claude-code_sample/docs/tr/README.md)
...
자세한 내용은 [`rules/README.md`](everything-claude-code_sample/rules/README.md)를 참고하세요.
...
[CONTRIBUTING.md](everything-claude-code_sample/CONTRIBUTING.md)를 참고하세요. 간단히 말하면:
1. 저장소를 포크
...
기여해 주세요! 가이드라인은 [CONTRIBUTING.md](everything-claude-code_sample/CONTRIBUTING.md)를 참고하세요.
...
[**스폰서 되기**](https://github.com/sponsors/affaan-m) | [스폰서 티어](everything-claude-code_sample/SPONSORS.md) | [스폰서십 프로그램](everything-claude-code_sample/SPONSORING.md)
