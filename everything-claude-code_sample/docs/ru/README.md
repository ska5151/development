**Язык:** [English](everything-claude-code_sample/README.md) | [Português (Brasil)](everything-claude-code_sample/docs/pt-BR/README.md) | [简体中文](README.zh-CN.md) | [繁體中文](everything-claude-code_sample/docs/zh-TW/README.md) | [日本語](everything-claude-code_sample/docs/ja-JP/README.md) | [한국어](everything-claude-code_sample/docs/ko-KR/README.md) | [Türkçe](everything-claude-code_sample/docs/tr/README.md) | **Русский**

# Everything Claude Code

![Everything Claude Code — система повышения эффективности сред агентного ИИ](hero.png)
...
[**English**](everything-claude-code_sample/README.md) | [Português (Brasil)](everything-claude-code_sample/docs/pt-BR/README.md) | [简体中文](README.zh-CN.md) | [繁體中文](everything-claude-code_sample/docs/zh-TW/README.md) | [日本語](everything-claude-code_sample/docs/ja-JP/README.md) | [한국어](everything-claude-code_sample/docs/ko-KR/README.md) | [Türkçe](everything-claude-code_sample/docs/tr/README.md) | **Русский**
...
ECC v2.0.0-rc.1 добавляет публичную историю оператора Hermes поверх этого переиспользуемого слоя: начните с [руководства по настройке Hermes](HERMES-SETUP.md), затем прочитайте [примечания к выпуску rc.1](everything-claude-code_sample/docs/releases/2.0.0-rc.1/release-notes.md) и [архитектуру для разных сред](cross-harness.md).
...
Детали установки и структуры смотрите в [`rules/README.md`](everything-claude-code_sample/rules/README.md).
...
См. [CONTRIBUTING.md](everything-claude-code_sample/CONTRIBUTING.md). Короткая версия:
...
Пожалуйста, внесите вклад. См. [CONTRIBUTING.md](everything-claude-code_sample/CONTRIBUTING.md) для рекомендаций.
...
[**Стать спонсором**](https://github.com/sponsors/affaan-m) | [Уровни спонсорства](everything-claude-code_sample/SPONSORS.md) | [Программа спонсорства](everything-claude-code_sample/SPONSORING.md)
...
- **Руководство по безопасности:** [Security Guide](everything-claude-code_sample/the-security-guide.md) | [Тред](https://x.com/affaanmustafa/status/2033263813387223421)
