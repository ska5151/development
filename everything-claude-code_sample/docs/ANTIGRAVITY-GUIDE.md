...
See [CONTRIBUTING.md](everything-claude-code_sample/CONTRIBUTING.md) for the full contribution guide.
...
- [CONTRIBUTING.md](everything-claude-code_sample/CONTRIBUTING.md) — how to contribute skills, agents, and commands
