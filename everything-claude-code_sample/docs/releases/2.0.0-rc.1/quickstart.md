...
This runs the [observability readiness gate](observability-readiness.md)
...
- [Cross-harness architecture](cross-harness.md)
- [Release notes](everything-claude-code_sample/docs/releases/2.0.0-rc.1/release-notes.md)
