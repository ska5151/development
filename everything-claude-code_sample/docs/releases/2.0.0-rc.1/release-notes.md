...
- Added a local [observability readiness gate](observability-readiness.md) for loop status, session traces, harness audit, and ECC2 tool-risk logs.
...
3. Review the [cross-harness architecture](cross-harness.md).
4. Run the [observability readiness gate](observability-readiness.md).
