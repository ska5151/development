...
> Bu dosya [common/git-workflow.md](everything-claude-code_sample/docs/tr/rules/common/git-workflow.md) dosyasını git işlemlerinden önce gerçekleşen tam özellik geliştirme süreci ile genişletir.
...
4. **Commit & Push**
   ...
   - Commit mesaj formatı ve PR süreci için [git-workflow.md](everything-claude-code_sample/docs/tr/rules/common/git-workflow.md) dosyasına bak
