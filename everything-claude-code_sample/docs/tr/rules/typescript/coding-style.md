...
> Bu dosya [common/coding-style.md](everything-claude-code_sample/docs/tr/rules/common/coding-style.md) dosyasını TypeScript/JavaScript'e özgü içerikle genişletir.
