...
- **Cursor**: `.cursor/` içinde önceden çevrilmiş config'ler. [Cursor IDE Desteği](everything-claude-code_sample/README.md#cursor-ide-support) bölümüne bakın.
- **OpenCode**: `.opencode/` içinde tam plugin desteği. [OpenCode Desteği](everything-claude-code_sample/README.md#opencode-support) bölümüne bakın.
...
[CONTRIBUTING.md](everything-claude-code_sample/CONTRIBUTING.md)'ye bakın. Kısa versiyon:
...
Lütfen katkıda bulunun! Rehber için [CONTRIBUTING.md](everything-claude-code_sample/CONTRIBUTING.md)'ye bakın.
