**言語:** [English](everything-claude-code_sample/README.md) | [Português (Brasil)](everything-claude-code_sample/docs/pt-BR/README.md) | [简体中文](README.zh-CN.md) | [繁體中文](everything-claude-code_sample/docs/zh-TW/README.md) | [日本語](everything-claude-code_sample/docs/ja-JP/README.md) | [한국어](everything-claude-code_sample/docs/ko-KR/README.md) | [Türkçe](everything-claude-code_sample/docs/tr/README.md)
...
インストールと構造の詳細は[`rules/README.md`](everything-claude-code_sample/docs/ja-JP/rules/README.md)を参照してください。
...
ぜひ貢献してください！ガイドについては[CONTRIBUTING.md](everything-claude-code_sample/docs/ja-JP/CONTRIBUTING.md)を参照してください。
